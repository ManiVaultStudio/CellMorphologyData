...
class CellMorphologyDataConan(ConanFile):
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/CellMorphologyData",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/CellMorphologyData")
        cmake.verbose = True
        return cmake
